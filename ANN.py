# -*- coding: utf-8 -*-
"""
Created on Wed Sep 20 12:21:05 2023
...
#Compiling the ANN.
classifier.compile(optimizer="adam", loss="binary_crossentropy", metrics=["accuracy"] )#loss="catrgorical_crossentropy" for multiple output values
